...
void Store::Initialise(std::string filename) {
   ...
   } else std::cout << "\033[38;5;196m WARNING!!!: Config file " << filename <<
         " does not exist no config loaded \033[0m" << std::endl;
...
void Store::Print() {
   ...
   for(std::map < std::string, std::string >::iterator it = m_variables.begin();
